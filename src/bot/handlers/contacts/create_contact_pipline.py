...
from src.bot.keyboards import main_kb, make_row_keyboard_by_list, contact_profile_kb
...
async def set_name(message: Message, state: FSMContext):
    ...
    try:
        ...
        await message.reply(f'❌ Contact *{name}* already exists. Type another name or cancel:') # TODO добавить жирный текст
