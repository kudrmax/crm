...
from src.bot.handlers.pipelines.create_contact import router as create_contact_pipeline
from src.bot.handlers.pipelines.delete_contact import router as delete_contact_pipeline
